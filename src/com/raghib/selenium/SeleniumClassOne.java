...
public class SeleniumClassOne {
	...
	public static void OperaBrowserMethod() throws InterruptedException {
		//Opera Browser
		OperaOptions options = new OperaOptions();
		options.setBinary("C:\\Users\\raghi\\AppData\\Local\\Programs\\Opera\\60.0.3255.170\\opera.exe");
		options.setExperimentalOption("useAutomationExtension", false);	//To remove notification for - Chrome Automation Extension.
		//System.setProperty("webdriver.opera.driver","C:\\SELENIUM\\browser-driver\\operadriver_win32\\operadriver.exe");
